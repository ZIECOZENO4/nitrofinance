  ...
  const handleSwap = () => {
    toast.success(
      <div>
        ...
        You are swapping {baseAmount} {baseToken?.name} for {quoteAmount}{" "}
        {quoteToken?.name}
      </div>,
      {
                    ...
                    <div className="bg-black text-white p-6 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm mb-8">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>
                            {" "}
                            {baseAmount} {baseToken?.name} for {quoteAmount}{" "}
                            {quoteToken?.name}
                          </span>
                        </div>
                        <div className="flex justify-between">
