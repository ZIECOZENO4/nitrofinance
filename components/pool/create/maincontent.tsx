...
>
  ...
  >
    <input
      ...
      className="bg-[#121212] border border-slate-800 p-6 rounded w-full outline-none focus:outline-none focus:ring-2 focus:ring-purple-600 placeholder-gray-500 pr-32"
      placeholder="0.00"
    />
    <div className="absolute right-3 flex gap-3 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none">
